    ...
    previewNavbar.innerHTML = `
        <div class="container flex text-center jc-ai-center">
            ...
            <div class="site-title flex align-item-center">
                <div>
                    <a href="index.html"><h1><span class="clr-red">Cafedemia</span></h1></a>
                </div>
                <!-- Toggle Bars -->
...
var bestDishes = [
    {
        ...
        rating: 4,
        imgURL: "assets/images/Masala-sdwch.jfif",
        description: "Sumptuous delicious food baked in our canteen with curated ingredients",
        price: 30
    },
    {
        title: 'Samosa',
        rating: 5,
        imgURL: "assets/images/samosa.jfif",
        description: "Sumptuous delicious food baked in our canteen with curated ingredients",
        price: 45
    },
    {
        title: 'Noodles',
        rating: 5,
        imgURL: "assets/images/noodles.jfif",
        description: "Sumptuous delicious food baked in our canteen with curated ingredients",
        price: 25
    },
    {
        title: 'French Fries',
        rating: 4,
        imgURL: "assets/images/ffries.jfif",
        description: "Sumptuous delicious food baked in our canteen with curated ingredients",
        price: 35
    }
]
...
if (signUpModal){
    ...
    <div class="modal-container">
        ...
        <div class="modal-content">
            <div class="md">Welcome to <br><span class="clr-red md">Cafedemia</span></div>
